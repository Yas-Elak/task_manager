...
@section('content')
    <h1>Hello you have an update to the Task : {{$data->subject}}</h1>
    ...
    <table cellspacing="0" cellpadding="10" border="1">
        ...
        <tr>
            ...
            <td width="280">{{$data->manager->email}}</td>
        </tr>
        @foreach($data->users()->get() as $user)
            <tr>
                <td width="100">Users : {{$loop->iteration}}</td>
